      ...
      children: {
        ...
        "neurotrack.txt": {
          ...
          content: [
            ...
            "LIVE:   neuro-track-lime.vercel.app",
            "REPO:   github.com/pd241008/NeuroTrack",
            "DOCS:   neurotrack-docs.pdf",
          ].join("\n"),
        },
        "intellivod.txt": {
          type: "file",
        ...
        "expense-manager.txt": {
          type: "file",
          content: [
            "PROJECT:  Expense Manager E-Wallet",
            "TYPE:     Financial Tools",
            "STATUS:   PRODUCTION",
            "",
            "Production-grade expense management platform with real-time",
            "transaction tracking and category analytics. Built on Next.js 14",
            "with Convex serverless backend and Clerk authentication.",
            "",
            "STACK:  Next.js · Convex · Clerk · TypeScript · Framer Motion",
            "LIVE:   expense-tracker-e-wallet.vercel.app",
            "DOCS:   expense-manager-docs.pdf",
          ].join("\n"),
        },
        "analysis-agent.txt": {
          type: "file",
          content: [
            ...
            "AI agents monitor global data to detect disruptions,",
            "assess impact, and automate preventive actions.",
            "",
            "STACK:  Python · FastAPI · Multi-Agent · NLP · Next.js",
            "REPO:   [ ACCESS_RESTRICTED ]",
            "DOCS:   analysis-agent-docs.pdf",
          ].join("\n"),
        },
        "devtrace.txt": {
          type: "file",
          content: [
            ...
            "STATUS:   DRAFT",
            "",
            "High-performance inline proxy for API traffic capture,",
            "replay, and introspection. CQRS architecture with a",
            "Rust interception engine and plugin system.",
            "",
            "STACK:  Rust · Tokio · Hyper · Next.js · Express · TypeScript",
            "REPO:   [ ACCESS_RESTRICTED ]",
            "DOCS:   devtrace-readme.pdf",
          ].join("\n"),
        },
        "gram-sewek.txt": {
          type: "file",
          content: [
            ...
            "STATUS:   DRAFT",
            "",
            "Complaint management system for rural governance.",
            "Dual-backend with Express + MongoDB auth and FastAPI",
            "microservice for AI-driven complaint categorization.",
            "",
            "STACK:  TypeScript · Express · MongoDB · FastAPI · Next.js",
            "REPO:   [ ACCESS_RESTRICTED ]",
            "DOCS:   gram-sewek-docs.pdf",
          ].join("\n"),
        },
        "neoshell.txt": {
          type: "file",
          content: [
            ...
            "STATUS:   DRAFT",
            "",
            "Zero-config IDE shell built around Neovim via Tauri.",
            "Embeds nvim --embed via RPC for seamless editing.",
            "Features session intelligence and DevTrace integration.",
            "",
            "STACK:  Rust · Tauri · Neovim · RPC · Session Mgmt",
            "REPO:   [ ACCESS_RESTRICTED ]",
            "DOCS:   neoshell-docs.pdf",
          ].join("\n"),
        },
        "taskiee.txt": {
          type: "file",
          content: [
            ...
            "STATUS:   DRAFT",
            "",
            "Role-based task management portal with Kanban board.",
            "Drag-and-drop orchestration, hierarchical RBAC, and",
            "Neo-Brutalism design. Built with dnd-kit and MongoDB.",
            "",
            "STACK:  Next.js · Express · MongoDB · TypeScript · dnd-kit",
            "REPO:   [ ACCESS_RESTRICTED ]",
            "DOCS:   taskiee-docs.pdf",
          ].join("\n"),
        },
      },
    },
